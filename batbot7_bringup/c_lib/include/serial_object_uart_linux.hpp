#ifndef SERIAL_OBJECT_UART_LINUX_HPP
#define SERIAL_OBJECT_UART_LINUX_HPP

/**
 * @author Jayson De La Vega
 * @date 2024-8-24
 * @ C Library for serial communication (Linux)
 *
 * Adapted from
...
class SerialObject_UART_Linux : public SerialObject {
...
public:
   ...
   */
  SerialObject_UART_Linux(std::string portName);

  /**
   * @brief Destroy the bb serial object
   */
  ~SerialObject_UART_Linux();
